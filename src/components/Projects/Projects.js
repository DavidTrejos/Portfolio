        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Plant AI"
              description="In this project, I developed a cross-platform delivery application for both iOS and Android using Clean Architecture and MVVM design patterns. The application was built using React Native, Node.js, and MySQL"
